                                ...
                                <div class="card card-small mb-3">
                                    <div class="card-body">
                                        <form class="add-new-post" id="form">
                                            <input id="judul" name="judul" class="form-control form-control-lg mb-3" type="text" placeholder="Judul Berita" value="<?= $menu["judul_sub"] === "Tambah" ? "" : $data["judul"] ?>">
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            ...
                            .then((value) => {
                                ...
                                window.location.assign(`<?= base_url("pengurus/")."berita/" ?>`+response.keterangan.id);
                            });
                        } else {
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200) {
                            ...
                            swal({
                                ...
                                text: "Berita diperbarui pada "+`<?= date("d M Y (H:i:s")." WIB)" ?>`+" dan masuk dalam daftar \""+keterangan_status.toLowerCase()+"\".",
                                icon: "success",
                                button: "Tutup",
                            });
                        } else {
